...
# Reshape the future features for GRU input
...
# 8. Predict gold price using both models (RandomForest and MLP)
rf_gold_pred = rf_gold_model.predict(future_features.values)  # Ensure future_features is a numpy array
mlp_gold_pred = mlp_gold_model.predict(future_features.values)  # Ensure future_features is a numpy array
